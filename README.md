...
- **📁 Token-Saving Workspace Map & Tree**: Pre-indexes a compact directory tree, key entry points, and structural file outline on session start, cutting up to **90%+ of initial exploratory search tokens**.
...
│   ├── src/
│   │   ├── components/     # UI (Header, Sidebar, MainCanvas, FileViewer, SkillsHub)
