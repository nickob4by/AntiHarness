...
export default function Sidebar({ 
  ...
  return (
    <aside 
      ...
      className="border-r border-border bg-surface/60 backdrop-blur flex flex-col h-full select-none text-xs shrink-0 overflow-hidden"
    >
      {/* Top Header: Projects & Add (+) Button */}
      <div className="px-3.5 py-3 border-b border-border/80 flex items-center justify-between">
      ...
      {/* Projects List (Edge Sidebar Type) */}
